...
-- independent pairs.
--
-- Real lead found but NOT modeled here (Rules-instrument amendment-history
-- shape, not a single amendment-to-original pair):
--   - G.S.R. 418(E) (29 May 2026) amends the Legal Metrology (Packaged
--     Commodities) Rules, 2011 (G.S.R. 202(E), 7 Mar 2011), itself already
--     amended by G.S.R. 312(E) (27 Apr 2026).
