...
Established over 8 batches so far, unchanged going forward:
...
2. For each result: check whether it fits one of the existing shared templates (`extract/common_templates.py`: amendment-in-notification, corrigendum-substitution, supersession-preamble, note-chain) or an existing ministry-specific module (reuse `find_after_anchor` with a custom anchor, per `extract/railways_patterns.py` / `extract/chemicals_fertilizers_patterns.py`). Only write a genuinely new template after 2+ independent real confirmations — never from one example.
...
**39 of 57 ministries/departments processed** (36 modeled, 3 abandoned). 18 remain.

### Done — modeled (36)

Agriculture and Farmers Welfare · Ayush · Chemicals and Fertilizers · Civil Aviation · Coal · Communications · Consumer Affairs, Food and Public Distribution · Corporate Affairs · Culture · Defence · Earth Sciences · Electronics and Information Technology · Environment, Forest and Climate Change · Finance (Revenue/CBIC only — see Batch 12) · Fisheries, Animal Husbandry and Dairying · Food Processing Industries · Health and Family Welfare · Heavy Industries · Home Affairs · Housing and Urban Affairs · Labour and Employment · Micro, Small and Medium Enterprises · Mines · Minority Affairs · New and Renewable Energy · Petroleum and Natural Gas · Power · Railways · Road Transport and Highways · Rural Development · Skill Development and Entrepreneurship · Social Justice and Empowerment · Steel · Textiles · Tribal Affairs · Women and Child Development
...
### Pending (18) — batch schedule

**Batch 9 (next):** Commerce and Industry · External Affairs · Personnel, Public Grievances and Pensions · Statistics and Programme Implementation · Ports, Shipping and Waterways

**Batch 10:** Science and Technology · Department of Space · Department of Atomic Energy · Jal Shakti (Water Resources, River Development and Ganga Rejuvenation + Drinking Water and Sanitation) · Information and Broadcasting

**Batch 11:** Youth Affairs and Sports · Education — School Education and Literacy · Education — Higher Education · Cooperation · Development of North Eastern Region (DoNER)
